...
//    ! Description : Generate binomial coefficient
    ...
    nck = int64_t((exp(log_n_factorial - log_k_factorial - log_n_minus_k_factorial))+0.5);
...
//    ! ----------------------------------------------------------------------------------------------
    ...
    dets.clear();
    num_configs=n_choose_k_64(num_sites,num_ones);
    cout<<"Number of configs = "<<num_configs<<endl;
